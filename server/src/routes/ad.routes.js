...
import {createAd, updateAd, deleteAd, getMyAds, recordImpression, recordClick, recordVideoComplete, getFeedAd, getVideoAd,} from "../controllers/ad.controller.js";
...
router.post("/:adId/video-complete", recordVideoComplete);
